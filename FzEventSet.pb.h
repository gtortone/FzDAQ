...
inline void FzData::set_type(::DAQ::FzData_FzDataType value) {
  GOOGLE_DCHECK(::DAQ::FzData_FzDataType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void FzHit::set_telid(::DAQ::FzHit_FzTelescope value) {
  GOOGLE_DCHECK(::DAQ::FzHit_FzTelescope_IsValid(value));
  set_has_telid();
  telid_ = value;
}
...
inline void FzHit::set_detid(::DAQ::FzHit_FzDetector value) {
  GOOGLE_DCHECK(::DAQ::FzHit_FzDetector_IsValid(value));
  set_has_detid();
  detid_ = value;
}
...
inline void FzHit::set_feeid(::DAQ::FzHit_FzFec value) {
  GOOGLE_DCHECK(::DAQ::FzHit_FzFec_IsValid(value));
  set_has_feeid();
  feeid_ = value;
}
...
inline void FzFee::set_feeid(::DAQ::FzFee_FzFec value) {
  GOOGLE_DCHECK(::DAQ::FzFee_FzFec_IsValid(value));
  set_has_feeid();
  feeid_ = value;
}
