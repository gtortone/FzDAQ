...
main ()
{
  int log4cpp_major, log4cpp_minor;
  int major, minor;
  char *tmp_version;
  ...
  if (sscanf(tmp_version, "%d.%d", &major, &minor) != 2) {
   ...
   {
        printf("\n*** An old version of LOG4CPP (%d.%d) was found.\n",
               log4cpp_major, log4cpp_minor);
        printf("*** You need a version of LOG4CPP newer than %d.%d. The latest version of\n",
	       major, minor);
        printf("***\n");
